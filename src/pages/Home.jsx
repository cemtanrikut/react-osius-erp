                    ...
                    {recentTickets.map((ticket) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 text-gray-500 text-sm">
                                <span className={`px-2 py-1 text-xs font-bold rounded-md ${"bg-gray-300 text-black"
                                    }`}>
                                    {ticket.status || "Done"}
                                </span>
                                <span className={`px-2 py-1 text-xs font-bold rounded-md ${ticket.priority === "critical" ? "bg-black text-white" :
