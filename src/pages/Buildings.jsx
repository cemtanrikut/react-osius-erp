        ...
        <div className="p-6">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg shadow-xl w-96">
                        ...
                        <div className="mt-3 space-y-3">
                            ...
                            <p className="flex items-center">
                                <FaCheckCircle
                                    className={`mr-2 ${selectedBuilding.status === "Active"
                                            ? "text-green-500"
            ...
            <div className="flex justify-between items-center mt-4">
                <p className="text-gray-600">
                    Showing {(filteredBuildings?.length || 0) > 0 ? indexOfFirstBuilding + 1 : 0}-
                    {(filteredBuildings?.length || 0) > 0 ? Math.min(indexOfLastBuilding, filteredBuildings.length) : 0}
                    of {filteredBuildings?.length || 0} buildings
                </p>

                <div className="flex gap-2">
                    <button
                        className={`px-3 py-1 rounded-lg ${currentPage === 1 ? "bg-gray-300" : "bg-blue-500 text-white hover:bg-blue-600"}`}
                        disabled={currentPage === 1 || (filteredBuildings?.length || 0) === 0}
                    ...
                    <button
                        className={`px-3 py-1 rounded-lg ${currentPage >= Math.ceil((filteredBuildings?.length || 1) / buildingsPerPage) ? "bg-gray-300" : "bg-blue-500 text-white hover:bg-blue-600"}`}
                        disabled={currentPage >= Math.ceil((filteredBuildings?.length || 1) / buildingsPerPage)}
                        onClick={() => setCurrentPage((prev) => prev + 1)}
                    >
                        Next
                    </button>
